const { RelatedRecordsOperations, DelinkRecordsParam, GetRelatedRecordHeader, GetRelatedRecordsHeader, GetRelatedRecordsParam } = require("@zohocrm/nodejs-sdk-2.0/core/com/zoho/crm/api/related_records/related_records_operations");
const ResponseWrapper = require("@zohocrm/nodejs-sdk-2.0/core/com/zoho/crm/api/related_records/response_wrapper").ResponseWrapper;
const FileBodyWrapper = require("@zohocrm/nodejs-sdk-2.0/core/com/zoho/crm/api/related_records/file_body_wrapper").FileBodyWrapper;
const BodyWrapper = require("@zohocrm/nodejs-sdk-2.0/core/com/zoho/crm/api/related_records/body_wrapper").BodyWrapper;
const ActionWrapper = require("@zohocrm/nodejs-sdk-2.0/core/com/zoho/crm/api/related_records/action_wrapper").ActionWrapper;
const ZCRMRecord = require("@zohocrm/nodejs-sdk-2.0/core/com/zoho/crm/api/record/record").Record;
const APIException = require("@zohocrm/nodejs-sdk-2.0/core/com/zoho/crm/api/related_records/api_exception").APIException;
const SuccessResponse = require("@zohocrm/nodejs-sdk-2.0/core/com/zoho/crm/api/related_records/success_response").SuccessResponse;
...
class RelatedRecord {
    ...
    static async updateRelatedRecords(moduleAPIName, recordId, relatedListAPIName) {
         ...
         * 2 -> Value
         */
        record1.addKeyValue("id", 347706110640047n);
         ...
         * 2 -> Value
         */
        record2.addKeyValue("id", 347706110538010n);
    ...
    static async getRelatedRecordsUsingExternalId(moduleAPIName, externalValue, relatedListAPIName) {
        //example
        //let moduleAPIName = "Products";
        // let externalValue = "34096430798007";
        // let relatedListAPIName = "Price_Books";
    ...
    static async getRelatedRecord(moduleAPIName, recordId, relatedListAPIName, relatedListId, destinationFolder) {
        ...
        //Call getRelatedRecord method that takes relatedListId and headerInstance as parameter
    ...
    static async updateRelatedRecord(moduleAPIName, recordId, relatedListAPIName, relatedListId) {
        ...
        //Call updateRelatedRecord method that takes relatedRecordId, recordId and BodyWrapper instanceas parameter.
    ...
    static async getRelatedRecordUsingExternalId(moduleAPIName, externalValue, relatedListAPIName, externalFieldValue, destinationFolder) {
        //example
        // let moduleAPIName = "Products";
        // let externalValue = 34096430798007n;
        // let relatedModuleAPIName = "Price_Books";
        ...
        //Call getRelatedRecordUsingExternalId method that takes externalFieldValue, headerInstance and externalValue as parameter
    ...
    static async updateRelatedRecordUsingExternalId(moduleAPIName, externalValue, relatedListAPIName, externalFieldValue) {
        ...
        //Call updateRelatedRecordUsingExternalId method that takes externalFieldValue, externalValue and BodyWrapper instanceas parameter.
    ...
    static async deleteRelatedRecordUsingExternalId(moduleAPIName, externalValue, relatedListAPIName, externalFieldValue) {
        ...
        //Get instance of RelatedRecordsOperations Class that takes relatedListAPIName and moduleAPIName and xExternal as parameter
        let relatedRecordsOperations = new RelatedRecordsOperations(relatedListAPIName, moduleAPIName, xExternal);
